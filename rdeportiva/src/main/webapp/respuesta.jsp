						...
						<p>
							<%
								...
								if (clave == null || clave.length() < 8) {
							        session.setAttribute("errorClave", "La contraseña debe tener al menos 8 caracteres");
							        response.sendRedirect("tuPaginaDeRegistro.jsp");
							        return;
							    }
							    
								int estadoCivil = Integer.parseInt(ecivil);
								
								Usuario user = new Usuario(2,estadoCivil,cedula,nombre,correo,clave,true);
